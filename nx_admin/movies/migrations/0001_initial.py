# Generated by Django 4.2.17 on 2025-12-13 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'Movie'), ('tv_show', 'TV Show')], default='movie', max_length=150, verbose_name='type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('actor', 'Actor'), ('writer', 'Writer'), ('director', 'Director')], default='actor', max_length=255, verbose_name='role')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
