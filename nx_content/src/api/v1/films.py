...
@redis_caching(key_base="movies_search_v2_", response_model=Film)
async def film_search(
    ...
    return [
        Film(
            ...
            type=getattr(film, "type", None),
            preview=getattr(film, "preview", None),
...
@redis_caching(key_base="movies_main_v2_", response_model=Film)
